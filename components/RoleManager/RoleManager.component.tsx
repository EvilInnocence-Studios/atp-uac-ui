...
export const RoleManagerComponent = overridable(({ roles, isLoading, name, description, setName, setDescription, create, columns, classes = styles }: RoleManagerProps) =>
